...
--data-raw '{
    "FixedAmountRequest": {
        "recipient": "0xf993accfe9d1951241ef0cb81cfad333290310b08df6b00643c802a2ce1cb996"
    }
}'
```
...
```ts
export const DEVNET_COUNTER_PACKAGE_ID = "0x5720085887fa77e2415954c1279748d302748198b56fd07f4ab7e36b2fb5f1b4";
```
